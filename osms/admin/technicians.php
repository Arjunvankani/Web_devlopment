...
<div class="container-fluid" style="margin-top: 40px;"></div>
	<div class="row"><!-- start  row-->
		...
		<!--  end 2nd column-->
		<div class="col-sm-9">
			<h3 class="text-center text-white bg-dark">List of Technicians</h3>
			<?php
			...
			if($result->num_rows > 0)
			{
				echo '<table class="table text-center">';
					...
					while($row = $result->fetch_assoc())
					{
						...
						echo '<td>';
							echo '<form action="updatetechnician.php" method="POST" class="d-inline mr-3">';
								echo '<input type="hidden" name="id" value='.$row['empid'].'><button class="btn btn-primary"name="editt" value="Edit"><img src="https://img.icons8.com/android/24/000000/pencil.png"/>';
							echo '</form>';
							echo '<form action="" method="POST">';
								echo '<input type="hidden" name="id" value='.$row['empid'].'><button class="btn btn-dark"name="deletet" value="Delete"><img src="https://img.icons8.com/material-outlined/24/000000/delete-trash.png"/>';
							echo '</form>';
						echo '</td>';
					echo '</tbody>';
					}
