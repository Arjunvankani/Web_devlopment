		...
		<nav class="col-sm-2 bg-light sidebar py-2 d-print-none"><!-- start side bar 1st column-->
			<div class="sidebar-sticky">
				<ul class="nav flex-column" style="font-weight: bold;">
					...
					<li class="nav-item"><a class="nav-link bg-danger" style="color: white;" href="workreport.php"><img src="https://img.icons8.com/material-rounded/24/000000/business-report.png"/> Work Report</a></li>
